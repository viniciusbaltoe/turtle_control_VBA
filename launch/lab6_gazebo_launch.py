...
def generate_launch_description():
    ...
    declare_world_cmd = DeclareLaunchArgument(
        ...
        default_value=os.path.join(get_package_share_directory('turtle_control_VBA'), 'worlds', 'empty.world'),
    ...
    manager = Node(
        package='turtle_control_VBA',  # Substitua pelo nome do seu pacote
        executable='turtlebot_goal_manager',
        name='turtlebot_goal_manager',
        output='screen',
        emulate_tty=True,  # Permite a exibição de mensagens de log no terminal
    )
